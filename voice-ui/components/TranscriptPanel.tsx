    ...
    return (
        <div className="w-full h-full flex flex-col bg-slate-900/50 border-l border-white/10 overflow-hidden">
            <div className="p-4 border-b border-white/10">
                <h2 className="text-sm font-semibold uppercase tracking-wider text-slate-400">Live Transcript</h2>
            </div>
            ...
            >
                <AnimatePresence initial={false}>
                  ...
                  ${(msg as any).isInterim ? 'opacity-70 italic' : ''}`}
                            >
                                {msg.text}
                            </div>
                        </motion.div>
                ...
                {messages.length === 0 && (
                    <div className="h-full flex flex-col items-center justify-center space-y-2 opacity-30">
                        <div className="w-12 h-12 rounded-full border border-dashed border-white/30" />
