                ...
                <AnimatePresence>
                    {state !== "idle" && (
                        <motion.div
                            ...
                            className={`absolute -inset-10 rounded-full blur-3xl ${state === "speaking" ? "bg-emerald-500/20" :
                ...
                >
                    ...
                    {state === "listening" && (
                        <motion.div
                            ...
                            className="absolute inset-2 rounded-full bg-blue-300/20 blur-md"
                        />
                    )}
                    ...
                    {state === "speaking" && (
                        <motion.div
                            ...
                            className="absolute inset-0 border-[3px] border-white/40 rounded-full"
                        />
                    )}
                    ...
                    {state === "thinking" && (
                        <div className="absolute inset-0 flex items-center justify-center">
                            <motion.div
                                ...
                                className="w-1/2 h-1/2 border-t-2 border-r-2 border-white/60 rounded-full"
                            />
                            <motion.div
                                animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.6, 0.3] }}
                                transition={{ duration: 2, repeat: Infinity }}
                                className="absolute w-1/3 h-1/3 bg-white/20 rounded-full blur-xl"
                            />
                        </div>
                    )}
                </motion.div>
